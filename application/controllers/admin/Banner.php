...
class Banner extends Admin_Controller {
    ...
    public function insert()
    {
        ...
        $data = array(
            ...
            'banner_image'              => $image,
            'banner_link'               => check_link($this->input->post('banner_link')),
            'banner_sort'               => $this->input->post('banner_sort'),
            'banner_vertical_alignment' => $this->input->post('banner_vertical_alignment'),
        ...
        $this->session->set_flashdata('message', '首頁輪播圖建立成功！');
        redirect( base_url() . 'admin/banner');
    }

    public function edit($id)
    {
        $this->data['page_title'] = '編輯首頁輪播圖';
    ...
    public function update($id)
    {
        ...
        $this->session->set_flashdata('message', '首頁輪播圖編輯成功！');
    ...
    public function delete($id)
    {
        ...
        $this->session->set_flashdata('message', '首頁輪播圖刪除成功！');
        redirect( base_url() . 'admin/banner');
    }
        ...
        if (!empty($this->input->post('banner_id'))) {
            foreach ($this->input->post('banner_id') as $banner_id) {
                if($this->input->post('action')=='delete'){
                    ...
                    $this->db->where('banner_id', $banner_id);
                    $this->db->update('banner', $data);
                    $this->session->set_flashdata('message', '首頁輪播圖上架成功！');
                    ...
                    $this->db->where('banner_id', $banner_id);
                    $this->db->update('banner', $data);
                    $this->session->set_flashdata('message', '首頁輪播圖下架成功！');
                }
            }
        }
        redirect( base_url() . 'admin/banner');
